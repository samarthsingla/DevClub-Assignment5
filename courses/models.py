...
class Course(models.Model):
    ...
    members = models.ManyToManyField(Account, verbose_name="Students") #both student and instructor members. This is more flexible because if we decide to add more user types (maybe admins) then we can just add them too. Also, these classes can overlap too (example: admin is also an instructor)
